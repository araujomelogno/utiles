...
public class ExtrasReportDialog extends Dialog {
	...
	public ExtrasReportDialog(SurveyorService surveyorService, StudyService studyService, ExtraService extraService,
		...
		VerticalLayout layout = new VerticalLayout(fechaDesde, fechaHasta, encuestadores, estudios);
		add(layout);

		Button descargarButton = new Button("Descargar");
		descargarButton.addClickListener(e -> {
			List<Extra> extras = extraService.findExtrasByFilters(fechaDesde.getValue(), fechaHasta.getValue(),
