...
public class ExpenseReportViewDialog extends Dialog {
	...
	public ExpenseReportViewDialog(ExpenseReport expenseReport) {
		...
		surveyor.setValue(expenseReport.getSurveyor() != null
				? expenseReport.getSurveyor().getFirstName() + " " + expenseReport.getSurveyor().getLastName()
				: "");
