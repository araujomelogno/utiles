...
public class SurveyorJournalEntryView extends Div {
    ...
    public SurveyorJournalEntryView(AuthenticatedUser authenticatedUser, SurveyorService surveyorService,
        ...
        VerticalLayout mainLayout = new VerticalLayout(buttonLayout, expenseRequestGrid, grid);
    ...
    private void configureExpenseRequestGrid() {
        ...
        expenseRequestGrid.addColumn(ExpenseRequest::getCreationDate).setHeader("Fecha de Creación");
    }
    ...
    private void updateList(AuthenticatedUser authenticatedUser, SurveyorService surveyorService, JournalEntryService journalEntryService) {
        ...
        if (maybeUser.isPresent()) {
            ...
            if (surveyor.isPresent()) {
                ...
                expenseRequestGrid.setItems(expenseRequestService.findAllBySurveyorAndStatus(surveyor.get(), ExpenseStatus.INGRESADO));
            } else {
