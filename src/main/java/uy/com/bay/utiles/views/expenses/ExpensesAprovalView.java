...
public class ExpensesAprovalView extends Div {
    ...
    public ExpensesAprovalView(ExpenseRequestService expenseRequestService, ExpenseRequestTypeService expenseRequestTypeService) {
        ...
        layout.add(new H2("Aprobar Solicitudes de Gasto"));
    ...
    private void setupGrid() {
        ...
        Grid.Column<ExpenseRequest> requestDateColumn = grid.addColumn(er -> er.getRequestDate() != null ? new java.text.SimpleDateFormat("dd/MM/yyyy").format(er.getRequestDate()) : "").setHeader("Solicitado").setAutoWidth(true).setSortable(true).setSortProperty("requestDate");
        ...
        grid.addColumn(ExpenseRequest::getObs).setHeader("Observaciones").setAutoWidth(true);
