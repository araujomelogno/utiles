...
public class ExpenseReportsView extends Div implements BeforeEnterObserver {
    ...
    private final Button comprobantes = new Button("Comprobantes");
    ...
    private void createButtonLayout(Div editorLayoutDiv) {
        ...
        buttonLayout.add(save, cancel, delete, comprobantes);
    ...
    private void createGridLayout(SplitLayout splitLayout) {
        ...
        filterLayout.add(studyFilter, surveyorFilter, dateFromFilter, dateToFilter, amountFromFilter, amountToFilter, conceptFilter, statusFilter);
    ...
    private void openComprobantesDialog() {
        ...
        filesGrid.addColumn(file -> new java.text.SimpleDateFormat("dd/MM/yyyy").format(file.getCreated())).setHeader("Fecha de Creación");

        filesGrid.addComponentColumn(file -> {
            Button downloadButton = new Button("Descargar");
            StreamResource resource = new StreamResource(file.getName(), () -> new ByteArrayInputStream(file.getContent()));
